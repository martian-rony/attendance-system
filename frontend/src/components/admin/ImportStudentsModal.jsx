  ...
  return (
    ...
    >
      <div className="space-y-3">
        ...
        <label className="inline-flex cursor-pointer items-center gap-2 rounded-lg border border-input bg-white px-3 py-1.5 text-sm font-medium text-foreground hover:bg-muted/40">
